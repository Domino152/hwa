...
export interface AttendanceAnalytics {
  ...
  academicYear: string;
  overall: number;
  trend: Array<{ month: string; percentage: number }>;
  subjectWise: Array<{
    subject: string;
    percentage: number;
    total: number;
...
export interface IAttendanceRepository {
  findStudentAttendance(studentId: string): Promise<import('../../repositories/types.js').AttendanceRecord[]>;
  findByStudentAndSubject(studentId: string, subject: string): Promise<import('../../repositories/types.js').AttendanceRecord | null>;
  findByStudentAndSemester(studentId: string, semester: number, academicYear: string): Promise<import('../../repositories/types.js').AttendanceRecord[]>;
  upsertAttendance(record: Omit<import('../../repositories/types.js').AttendanceRecord, 'id'> & { id?: string }): Promise<import('../../repositories/types.js').AttendanceRecord>;
  upsertMany(records: Array<Omit<import('../../repositories/types.js').AttendanceRecord, 'id'> & { id?: string }>): Promise<number>;
  getDepartmentStats(department: string, semester: number, academicYear: string): Promise<Array<{ studentId: string; percentage: number; totalClasses: number; attendedClasses: number }>>;
  ...
  getStudentsBelowThreshold(semester: number, academicYear: string, threshold?: number): Promise<import('../../repositories/types.js').AttendanceRecord[]>;
  getAttendanceHistory(studentId: string, page: number, limit: number): Promise<{ records: import('../../repositories/types.js').AttendanceRecord[]; total: number }>;
